    ...
    public function up()
    {
        if (!Schema::hasTable('players')) {
            Schema::create('players', function (Blueprint $table) {
                ...
                $table->integer('prey_stamina_1')->nullable();
                $table->integer('prey_stamina_2')->nullable();
                $table->integer('prey_stamina_3')->nullable();
                $table->smallInteger('prey_column')->default(1);
